...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_getServerData_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/getServerData.js */ \"./src/modules/getServerData.js\");\n/* harmony import */ var _modules_postNewScore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/postNewScore */ \"./src/modules/postNewScore.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n \r\n\r\n\r\n\r\n// refresh button\r\nconst refreshScoresBtn = document.querySelector('.refresh-scores');\r\n\r\n// Form fields\r\nconst leaderName = document.querySelector('.leader-name');\r\nconst leaderScore = document.querySelector('.leader-score');\r\nconst leaderForm = document.querySelector('.leader-form');\r\n\r\n// form submit button event\r\nleaderForm.addEventListener('submit', async (e) => {\r\n  e.preventDefault();\r\n  await (0,_modules_postNewScore__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(leaderName.value, parseInt(leaderScore.value, 10));\r\n  leaderName.value = '';\r\n  leaderScore.value = '';\r\n});\r\n\r\nrefreshScoresBtn.addEventListener('click', () => {\r\n  (0,_modules_getServerData_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\n});\r\n\r\n(0,_modules_getServerData_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\n\r\n\r\n\n\n//# sourceURL=webpack://webpacksetup/./src/index.js?");

/***/ }),

/***/ "./src/modules/getServerData.js":
/*!**************************************!*\
  !*** ./src/modules/getServerData.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _showData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./showData */ \"./src/modules/showData.js\");\n\r\n\r\nconst getAllScoresData = async (id = 'Q4cft8wpKdezWg6GZ6qV') => {\r\n  await fetch(`http://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${id}/scores`)\r\n    .then((response) => response.json()) \r\n    .then((data) => { \r\n      const scoresArr = data.result;\r\n      const scoresArrSorted = scoresArr.sort((a, b) => parseFloat(b.score) - parseFloat(a.score));\r\n      (0,_showData__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(scoresArrSorted);\r\n    });\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getAllScoresData);\n\n//# sourceURL=webpack://webpacksetup/./src/modules/getServerData.js?");

/***/ }),

/***/ "./src/modules/postNewScore.js":
/*!*************************************!*\
  !*** ./src/modules/postNewScore.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst postNewScore = async (user = '', score = 0, gameId = 'Q4cft8wpKdezWg6GZ6qV') => {\n  const leader = {\n    user,\n    score,\n  };\n\n  await fetch(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameId}/scores`, {\n    method: 'POST',\n    body: JSON.stringify(leader),\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8',\n    },\n  })\n    .then((response) => response.json())\n    .then((data) => data.result);\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (postNewScore);\n\n//# sourceURL=webpack://webpacksetup/./src/modules/postNewScore.js?");
